function XYEEobj = fit_transmission_fixed_n(XYEEobj, varargin)
...
if skip_first
    ...
    opts.Lower = opts.StartPoint*0.1;
    opts.Upper = opts.StartPoint*1.9;
...
%             opts.Lower(1) = max([opts.Lower(1), 0]);
            opts.Lower(1:2) = opts.StartPoint(1:2);
            opts.Upper(1:2) = opts.StartPoint(1:2);
            opts.Lower(4) = max([opts.Lower(4), 1]);
